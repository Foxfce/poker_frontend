    ...
    return (
        <form method="dialog" onSubmit={handleSubmit(onSubmit)}>
            <fieldset disabled={isSubmitting} className="fieldset">
                <legend className="fieldset-legend">Join Table</legend>

                <label className="label">Table ID</label>
                <input type="email" className="input w-full  bg-gray-800 text-white" placeholder="Email" {...register('tableID')} />
